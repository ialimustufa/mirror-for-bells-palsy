...
- Estimator input provenance: counted current-version rows preserve used/omitted movement IDs, the usable-movements-only calculation flag, House-Brackmann required-input provenance, required/available/missing resting metric keys, and the complete-resting-metrics calculation flag.
    ...
    () => validateStatusArtifacts(status, {
      readArtifactText: artifactReader({
        "docs/validation/clinical-scale-agreement-2026-06-24.md": passingClinicalAgreementReport()
          ...
          .replace("- Estimator input provenance: counted current-version rows preserve used/omitted movement IDs, the usable-movements-only calculation flag, House-Brackmann required-input provenance, required/available/missing resting metric keys, and the complete-resting-metrics calculation flag.\n", "")
