...
const REQUIRED_DOC_CHECKS = [
  ...
  },
  {
    ...
    patterns: [/Safety Prompt Sources/i, /Validation Dataset Export/i, /clinical-scale agreement\s+report/i, /validationCaseId/i, /distinct validation-case/i, /reviewerId/i, /distinct pseudonymous reviewer ids/i, /not diagnosis/i],
  },
  {
  ...
  },
  {
    ...
    patterns: [/blinded label sheet/i, /reviewer-agreement/i, /30 reviewed clinical-scale assessment/i, /validationCaseId/i, /distinct validation-case/i, /reviewerId/i, /distinct pseudonymous reviewer ids/i, /clinician-assigned grade/i, /reference-standard controls/i],
  },
];
