...
const REQUIRED_DOC_CHECKS = [
  ...
  },
  {
    ...
    patterns: [/Safety Prompt Sources/i, /Validation Dataset Export/i, /clinical-scale agreement\s+report/i, /clinical-scale-agreement-reviewed/i, /validationCaseId/i, /distinct validation-case/i, /reviewerId/i, /distinct pseudonymous reviewer ids/i, /not diagnosis/i],
  },
  {
