...
function assessClinicalScaleReadiness(input = {}, options = {}) {
  ...
  return {
    ...
    validationSummary: {
      ...
      uniqueAssessmentClinicalScaleRecords: clinicalValidation.summary?.uniqueAssessmentClinicalScaleRecords ?? 0,
      duplicateClinicalScaleAssessmentIds: clinicalValidation.summary?.duplicateClinicalScaleAssessmentIds ?? [],
      duplicateClinicalScaleAssessmentIdCount: clinicalValidation.summary?.duplicateClinicalScaleAssessmentIdCount ?? 0,
      duplicateClinicalScaleAssessmentRecordCount: clinicalValidation.summary?.duplicateClinicalScaleAssessmentRecordCount ?? 0,
      missingClinicalScaleAssessmentIdCount: clinicalValidation.summary?.missingClinicalScaleAssessmentIdCount ?? 0,
