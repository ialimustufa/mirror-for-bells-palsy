...
export const EXERCISES = [
  ...
  { id: "water-swish", name: "Water Hold Swish", region: "cheeks", holdSec: 5, reps: 10, instruction: "Hold a small sip of water in your mouth, then move it from left to right and right to left slowly.", tip: "Use only a small sip. Skip this exercise if water makes you cough, choke, or feel unsafe swallowing." },
