...
export const EXERCISES = [
  ...
  { id: "blink", name: "Gentle Blink", region: "eyes", holdSec: 1, reps: 10, instruction: "Blink slowly and softly, closing both eyes together for a moment, then opening with control.", tip: "Keep the blink light. Avoid squeezing the eyes or pulling the cheek upward." },
  ...
  { id: "nose-wrinkle", name: "Nostril Flare", region: "nose", holdSec: 4, reps: 8, instruction: "Flare your nostrils outward, as if taking a deep breath through your nose. Hold gently, then relax.", tip: "Keep the motion outward from your resting nose shape. Avoid scrunching upward or pulling inward for this one." },
  ...
  { id: "water-hold-left", name: "Water Hold Left", region: "cheeks", holdSec: 5, reps: 4, instruction: "Hold a small sip of water on the left side of your mouth. Keep the lips sealed, hold gently, then return to neutral.", tip: "Use only a small sip. Skip this exercise if water makes you cough, choke, or feel unsafe swallowing." },
  { id: "water-hold-right", name: "Water Hold Right", region: "cheeks", holdSec: 5, reps: 4, instruction: "Hold a small sip of water on the right side of your mouth. Keep the lips sealed, hold gently, then return to neutral.", tip: "Use only a small sip. Skip this exercise if water makes you cough, choke, or feel unsafe swallowing." },
  ...
  { id: "emoji-raised-brow", name: "Emoji Raised Brow 🤨", region: "emoji", holdSec: 3, reps: 5, instruction: "Raise one eyebrow into a curious expression, then switch sides on the next rep. Keep the mouth relaxed.", tip: "Use a small, clean lift. Do not wrinkle the whole forehead to force the movement." },
  ...
  { id: "emoji-smirk", name: "Emoji Smirk 😏", region: "emoji", holdSec: 3, reps: 5, instruction: "Lift one corner of your mouth into a small smirk, then switch sides on the next rep. Keep the jaw loose.", tip: "Keep the movement tiny and controlled so the stronger side does not yank the smile across." },
  { id: "emoji-pucker", name: "Emoji Pucker 😗", region: "emoji", holdSec: 4, reps: 5, instruction: "Pucker your lips forward into a small kiss face. Hold the center line steady, then relax.", tip: "Keep the lips soft and centered. Avoid clenching the jaw or pulling toward one side." },
